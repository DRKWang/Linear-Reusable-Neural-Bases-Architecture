...
class shared_FeedForward(nn.Module):
    def __init__(self, fc1, fc2, embed_dim, hidden_dim, dropout, act="gelu"):
        ...
        self.fc2 = fc2
        self.DA_table = nn.Parameter(1.0 * torch.randn(hidden_dim))
...
class shared_TransformerBlock(nn.Module):
    def __init__(self, fc1, fc2, embed_dim, num_heads, ff_hidden_dim, dropout, activation):
        super().__init__()
...
class transformer_rnb_4m(nn.Module):
    def __init__(
        self,
        vocab_size,
        seq_len,
